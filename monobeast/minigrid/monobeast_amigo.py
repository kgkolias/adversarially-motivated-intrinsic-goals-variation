...
# Ablations and other settings
    # We use an LSTM for the policy network when it is provided with partial observations, and a feed-forward network when provided with full observations
...
# The act() collects the batches generated by the actors
    ...
    try:
        ...
        while True:
            ...
            for t in range(flags.unroll_length):
                ...
                # Generate a New Goal when episode finished
...
# learn() updates the Learner() based on the vtrace, which is within the torchbeast/core folder
def learn(
